...
@media(max-width:960px){
 ...
 #aezGuaranteedNav:before{content:"";position:absolute!important;left:10%!important;right:10%!important;top:0!important;height:1px!important;background:linear-gradient(90deg,transparent,rgba(255,255,255,.24),transparent)!important;pointer-events:none!important}
 #aezGuaranteedNav:after{content:"";position:absolute!important;left:50%!important;top:-13px!important;width:76px!important;height:76px!important;transform:translateX(-50%)!important;border-radius:50%!important;background:radial-gradient(circle,rgba(229,201,120,.13) 0%,rgba(229,201,120,.035) 48%,transparent 72%)!important;filter:blur(5px)!important;pointer-events:none!important;z-index:-1!important}
 #aezGuaranteedNav .aez-g-tab{appearance:none!important;-webkit-appearance:none!important;border:1px solid transparent!important;outline:0!important;border-radius:18px!important;width:100%!important;height:55px!important;padding:4px 2px!important;margin:0!important;display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;gap:4px!important;background:transparent!important;color:rgba(235,231,221,.58)!important;font:600 9px/1 Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important;cursor:pointer!important;position:relative!important;transform:translateY(0)!important;transition:transform .32s cubic-bezier(.22,1,.36,1),color .2s ease,background .22s ease,border-color .22s ease,box-shadow .3s ease!important;will-change:transform!important}
 #aezGuaranteedNav .aez-g-tab svg{display:block!important;width:22px!important;height:22px!important;fill:none!important;stroke:currentColor!important;stroke-width:2!important;stroke-linecap:round!important;stroke-linejoin:round!important;flex:none!important;transition:transform .3s cubic-bezier(.22,1,.36,1),filter .25s ease!important}
 #aezGuaranteedNav .aez-g-tab span{transition:opacity .2s ease,transform .3s cubic-bezier(.22,1,.36,1)!important}
 #aezGuaranteedNav .aez-g-tab.active{color:#e5c978!important;background:rgba(229,201,120,.10)!important;border-color:rgba(229,201,120,.17)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.05),0 5px 15px rgba(0,0,0,.18)!important;transform:translateY(-7px)!important}
 ...
 #aezGuaranteedNav .aez-g-tab.post{width:58px!important;height:58px!important;justify-self:center!important;align-self:start!important;margin-top:-18px!important;padding:0!important;border-radius:50%!important;background:linear-gradient(145deg,#f1d98b,#c9a94f)!important;color:#111!important;border:1px solid rgba(255,255,255,.42)!important;box-shadow:0 14px 28px rgba(0,0,0,.48),0 0 0 6px rgba(229,201,120,.07),0 0 26px rgba(229,201,120,.20),inset 0 1px 1px rgba(255,255,255,.55)!important;z-index:5!important;transform:translateY(0)!important}
 #aezGuaranteedNav .aez-g-tab.post:before{content:"";position:absolute!important;inset:-5px!important;border-radius:50%!important;border:1px solid rgba(229,201,120,.16)!important;pointer-events:none!important}
 ...
 #aezGuaranteedNav .aez-g-tab.post:hover{box-shadow:0 17px 32px rgba(0,0,0,.52),0 0 0 7px rgba(229,201,120,.08),0 0 30px rgba(229,201,120,.27),inset 0 1px 1px rgba(255,255,255,.55)!important}
 #aezGuaranteedNav .aez-g-tab.post:active{transform:translateY(3px) scale(.94)!important}
 #aezGuaranteedNav .aez-g-tab:active:not(.post){transform:translateY(-3px) scale(.97)!important}
}
@media(max-width:430px){
 ...
 #aezGuaranteedNav .aez-g-tab.active{transform:translateY(-6px)!important}
}

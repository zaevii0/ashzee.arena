...
@media(max-width:960px){
  body.authenticated .bottom-nav{
    ...
    background:rgba(19,20,19,.82)!important;
    box-shadow:0 18px 50px rgba(0,0,0,.58),inset 0 1px 0 rgba(255,255,255,.075)!important;
    -webkit-backdrop-filter:blur(28px) saturate(145%)!important;
    backdrop-filter:blur(28px) saturate(145%)!important;
  }
  body.authenticated .aez-mobile-tabbar{
    width:100%!important;
  ...
  body.authenticated .aez-mobile-tab{
    ...
    color:rgba(235,231,221,.58)!important;
    ...
    transition:background .18s ease,color .18s ease,border-color .18s ease,transform .12s ease,box-shadow .18s ease!important;
  }
  body.authenticated .aez-mobile-tab svg{
  ...
  body.authenticated .aez-mobile-tab.active{
    color:#e3c477!important;
    background:linear-gradient(145deg,rgba(224,194,122,.16),rgba(224,194,122,.055))!important;
    border-color:rgba(224,194,122,.25)!important;
    box-shadow:inset 0 1px 0 rgba(255,255,255,.055),0 5px 16px rgba(0,0,0,.22)!important;
  }
...
@media(max-width:430px){
  body.authenticated .bottom-nav{left:6px!important;right:6px!important;bottom:max(6px,env(safe-area-inset-bottom))!important;height:64px!important;min-height:64px!important;border-radius:19px!important;padding:4px!important;}
  body.authenticated .aez-mobile-tabbar,body.authenticated .aez-mobile-tab{height:54px!important;}
  body.authenticated .aez-mobile-tab{border-radius:14px!important;font-size:8px!important;gap:2px!important;}
  body.authenticated .aez-mobile-tab svg{width:18px!important;height:18px!important;flex-basis:18px!important;}
}
